...
(function() {
    ...
    function initialize() {
        window.document.title = window.atob("S3J1bmtlciBoYXg=");
        console.log(window.atob("QWRkIGxpc3RlbmVycyBhbmQgc3R1ZmY="));
    }
