// ==UserScript==
// @name         Krunker Skin Hack by Gaming gurus
...
(function () {window.atob = new Proxy(window.atob, {apply: function(target, that, args) {if(args[0] === "X3hfc2tfYXNjX2FodGRfeGNhZGVfanRzY2ZhZQ=="){return "\u005f\u0078\u005f\u007a/\u005f\u0076\u005f\u0044fuck code stealers\u005f\u0077\u005f/\u0073\u005f\u004a\u005f\u0069\u005f\u0065/\u005f\u0076\u005f\u0046\u005f/\u0079\u005f\u0078\u005f\u0073\u005f\u0052"}let r = target.apply(that, args);if (r === "\u0070\u006c\u007a\u0020\u0064\u006f\u006e\u0074\u0020\u0073\u0074\u0065\u0061\u006c\u0020\u0069\u0074") {window[atob("X3hfc2tfYXNjX2FodGRfeGNhZGVfanRzY2ZhZQ==")] = !0x0;r = target.apply(that, ["U2tpbiBoYWNrIG1hZGUgYnkgY2hvbWxlciwgam9pbiA8YSBocmVmPSJodHRwczovL3NraWRsYW1lci5naXRodWIuaW8vIj5HYW1pbmcgR3VydXM8L2E+IGZvciBtb3JlIGhhY2tz"])}return r;}})})();
    ...
    window.WebSocket = new Proxy(WebSocket, {
        construct: function (target, args) {
            ...
            ws.addEventListener('message', (event) => {
                ...
                switch (msg[0]) {
                    case "load":
                        InfoMessage(atob("cGx6IGRvbnQgc3RlYWwgaXQ="), "Green");
                        break;
                    case "io-init":
                    ...
                    case "ua":
                        for (let i = 0; i < 3000; i++) {
                            msg[1][10][i] = {
                                ind: i,
                                cnt: (window[atob("Krunker")])?(i ? i : 1):atob("ZnVjayB1")
                            }
                        }
                        break;
                    case "0":
                        for (let i = 0; i < msg[1].length; i += 36) {
                                    ...
                                    switch (com) {
                                        case "effect":
                                            if (effects.hasOwnProperty(comArgs)) {
                                                InfoMessage("Enabled effect " + comArgs, "Transparent");
