...
// @namespace    I Have all skins
// @version      2.7.0
// @author       Krunker Java
// @description  Don't steal this code because it takes a lot of time to write this code.
// @match        *://krunker.io/*
// @exclude      *social.html*
// @require      https://github.com/Krunker-Java-plus-X-777/Krunker-Java-Plus-X
                ...
                switch (msg[0]) {
                    ...
                    case "a":
                        if (msg.length > 2) {
                            ...
                            InfoMessage("Skin Hack By Krunker Java Plus 𝓧", "limegreen");
                            InfoMessage("Skin Hacked Enjoy !!", "yellow");
                        }
                        break;
                    case "ua":
                        for (let i = 0; i < 3000; i++) {
                        ...
                        break;
                    case "0":
                        for (let i = 0; i < msg[1].length; i += 35) {
